...
convert_header(IMAGES + 'Plus8.png',                                                           BASE + 'Images.hpp', 'Plus8', 4, 23, 8)
convert_header(IMAGES + 'Quit.png',                                                            BASE + 'Images.hpp', 'Quit', 4)
convert_header(IMAGES + 'Bubble_00.png',                                                       BASE + 'Images.hpp', 'Bubble_00', 4)
convert_header(IMAGES + 'Bubble_01.png',                                                       BASE + 'Images.hpp', 'Bubble_01', 4)
convert_header(IMAGES + 'Bubble_02.png',                                                       BASE + 'Images.hpp', 'Bubble_02', 4)
